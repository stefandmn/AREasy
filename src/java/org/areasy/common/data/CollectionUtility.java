...
import org.areasy.common.data.type.collection.*;
 ...
 *
 * @version $Id: CollectionUtility.java,v 1.2 2008/05/14 09:32:29 swd\stefan.damian Exp $
 */
public class CollectionUtility
{
	...
	/**
	 * <code>CollectionUtility</code> should not normally be instantiated.
	 */
	...
	public static boolean containsAny(final Collection coll1, final Collection coll2)
	{
		if (coll1.size() < coll2.size())
		{
			...
			{
				if (coll2.contains(it.next())) return true;
			}
		}
		else
		{
			...
			{
				if (coll1.contains(it.next())) return true;
			}
		}
		return false;
	}
	...
	{
		return (a.size() < b.size()) && CollectionUtility.isSubCollection(a, b);
	}
	...
	public static int cardinality(Object obj, final Collection coll)
	{
		...
		{
			return ((Container) coll).getCount(obj);
		}
		int count = 0;
		if (obj == null)
		{
	...
	public static void filter(Collection collection, Predicate predicate)
	{
		if (collection != null && predicate != null)
		{
			for (Iterator it = collection.iterator(); it.hasNext();)
			{
				if (!predicate.evaluate(it.next())) it.remove();
			}
		}
	}
	 ...
	 * <p/>
	 * <pre>
	 * Collection c = CollectionUtility.synchronizedCollection(myCollection);
	 * synchronized (c) {
