...
import org.areasy.common.data.type.map.*;
 ...
 * </ul>
 *
 * @version $Id: MapUtility.java,v 1.2 2008/05/14 09:32:29 swd\stefan.damian Exp $
 */
public class MapUtility
{
	 ...
	 * Internal logger
	 */
	private static Logger logger = LoggerFactory.getLog(MapUtility.class);

	/**
	 * <code>MapUtility</code> should not normally be instantiated.
	 */
	public MapUtility()
	{
	}
	 ...
	 */
	public static void verbosePrint(final PrintStream out,
									final Object label,
									final Map map)
	{
	 ...
	 * @throws NullPointerException if the stream is <code>null</code>
	 */
	public static void debugPrint(final PrintStream out,
								  final Object label,
								  final Map map)
	{
	...
	/**
	 * Logs the given exception to the integrated logger.
	 * <p/>
	 *
	 ...
	 * @throws NullPointerException if the stream is <code>null</code>
	 */
	private static void verbosePrintInternal(final PrintStream out,
											 final Object label,
											 final Map map,
	 ...
	 * <p/>
	 * <pre>
	 * Map m = MapUtility.synchronizedMap(myMap);
	 ...
	 *     }
	 * }
	 * Map lazyMap = MapUtility.lazyMap(new HashMap(), factory);
	...
	{
		return SlowMap.decorate(map, factory);
	}
	...
	{
		return SlowMap.decorate(map, transformerFactory);
	}
	 ...
	 * <p/>
	 * <pre>
	 * Map m = MapUtility.synchronizedSortedMap(myMap);
	 * Set s = m.keySet();  // outside synchronized block
	 * synchronized (m) {  // synchronized on MAP!
	 *     Iterator i = s.iterator();
	 *     while (i.hasNext()) {
	 ...
	 *     }
	 * }
	 * SortedMap lazy = MapUtility.lazySortedMap(new TreeMap(), factory);
	...
	{
		return SlowSortedMap.decorate(map, factory);
	}
	...
	{
		return SlowSortedMap.decorate(map, transformerFactory);
	}
