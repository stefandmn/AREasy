 ...
 *
 * @version $Id: SystemUtility.java,v 1.4 2008/05/25 10:53:58 swd\stefan.damian Exp $
 */
public class SystemUtility
{
	...
	/**
	 * <p>Is <code>true</code> if this is Java version 1.7 (also 1.7x versions).</p>
	 * <p/>
	 * <p>The field will return <code>false</code> if {@link #JAVA_VERSION} is
	 * <code>null</code>.</p>
	 */
	...
	/**
	 * <p>Is <code>true</code> if this is Java version 1.8 (also 1.8x versions).</p>
	 * <p/>
	 * <p>The field will return <code>false</code> if {@link #JAVA_VERSION} is
	 * <code>null</code>.</p>
	 */
	...
	/**
	 * <p>SystemUtility instances should NOT be constructed in standard
	 * programming. Instead, the class should be used as
	 * <code>SystemUtility.FILE_SEPARATOR</code>.</p>
	 * <p/>
	...
	private static String getSystemProperty(String property)
	{
		...
		catch (SecurityException ex)
		{
			...
			System.err.println("Caught a SecurityException reading the system property '" + property
					+ "'; the SystemUtility property value will default to null.");
			return null;
		}
	}
