 ...
 * error occurs.</p>
 *
 * @version $Id: FloatConverter.java,v 1.2 2008/05/14 09:32:38 swd\stefan.damian Exp $
 */
...
public final class FloatConverter implements Converter
{
	...
	public Object convert(Class type, Object value)
	{
		...
		if (value instanceof Float) return (value);
			else if (value instanceof Number) return new Float(((Number) value).floatValue());
