 ...
 * error occurs.</p>
 *
 * @version $Id: IntegerConverter.java,v 1.2 2008/05/14 09:32:38 swd\stefan.damian Exp $
 */
...
public final class IntegerConverter implements Converter
{
	...
	public Object convert(Class type, Object value)
	{
		...
		if (value instanceof Integer) return (value);
			else if (value instanceof Number) return new Integer(((Number) value).intValue());
