 ...
 * error occurs.</p>
 *
 * @version $Id: ShortConverter.java,v 1.2 2008/05/14 09:32:38 swd\stefan.damian Exp $
 */
...
public final class ShortConverter implements Converter
{
	...
	public Object convert(Class type, Object value)
	{
		...
		if (value instanceof Short) return (value);
			else if (value instanceof Number) return new Short(((Number) value).shortValue());
