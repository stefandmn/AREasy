 ...
 *
 * @version $Id: BeanMap.java,v 1.2 2008/05/14 09:32:34 swd\stefan.damian Exp $
 */
public class BeanMap extends AbstractMap implements Cloneable
{
	 ...
	 * Internal logger
	 */
	private static Logger logger = LoggerFactory.getLog(BeanMap.class);
	...
	static
	{
		...
		defaultTransformers.put(Integer.TYPE,
				new Transformer()
				{
					public Object transform(Object input)
					{
