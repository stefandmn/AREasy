...
/**
 * Abstract implementation of the {@link Container} interface to simplify the creation
 ...
 *
 * @version $Id: AbstractMapContainer.java,v 1.2 2008/05/14 09:32:35 swd\stefan.damian Exp $
 */
public abstract class AbstractMapContainer implements Container
{
	 ...
	 */
	protected AbstractMapContainer()
	{
		super();
	}
	 ...
	 */
	protected AbstractMapContainer(Map map)
	{
		super();
		this.map = map;
	}
	...
	{
		if (coll instanceof Container)
		{
			return containsAll((Container) coll);
		}
		return containsAll(new HashContainer(coll));
	}
	 ...
	 * @return <code>true</code> if the Bag contains all the collection
	 */
	boolean containsAll(Container other)
	{
		boolean result = true;
	...
	{
		private AbstractMapContainer parent;
		 ...
		 */
		public BagIterator(AbstractMapContainer parent)
		{
			this.parent = parent;
	...
	public boolean retainAll(Collection coll)
	{
		if (coll instanceof Container)
		{
			return retainAll((Container) coll);
		}
		return retainAll(new HashContainer(coll));
	}
	 ...
	 */
	boolean retainAll(Container other)
	{
		boolean result = false;
		Container excess = new HashContainer();
	...
	public boolean equals(Object object)
	{
		...
		if (object instanceof Container == false)
		{
			return false;
		}
