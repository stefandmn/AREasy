 ...
 *
 * @version $Id: UnmodifiableContainer.java,v 1.2 2008/05/14 09:32:35 swd\stefan.damian Exp $
 */
public final class UnmodifiableContainer extends AbstractContainerDecorator implements Unmodifiable, Serializable
{
	/**
	...
	{
		if (container instanceof Unmodifiable)
		{
			return container;
		}
		return new UnmodifiableContainer(container);
	}
	 ...
	 * @throws IllegalArgumentException if bag is null
	 */
	private UnmodifiableContainer(Container container)
	{
		super(container);
	}
