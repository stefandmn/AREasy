 ...
 *
 * @version $Id: TreeList.java,v 1.2 2008/05/14 09:32:35 swd\stefan.damian Exp $
 */
public class TreeList extends AbstractList
{
	...
	{
		// override to go 75% faster cannot use EmptyIterator as iterator.add() must work
	...
	public Object[] toArray()
	{
		...
		if (root != null) root.toArray(array, root.relativePosition);
	...
	public void add(int index, Object obj)
	{
		...
		if (root == null) root = new AVLNode(index, obj, null, null);
	...
	{
		if (index < startIndex || index > endIndex) throw new IndexOutOfBoundsException("Invalid index: " + index + ", size = " + size());
	}
