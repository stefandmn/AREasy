...
import org.areasy.common.data.type.map.keyvalue.DefaultMapEntry;
 ...
 *
 * @version $Id: AbstractReferenceMap.java,v 1.2 2008/05/14 09:32:30 swd\stefan.damian Exp $
...
public abstract class AbstractReferenceMap extends AbstractHashedMap
{
	...
	protected static class ReferenceEntry extends HashEntry
	{
		...
		/**
		 * Creates a new entry object for the ReferenceEntry.
		 *
