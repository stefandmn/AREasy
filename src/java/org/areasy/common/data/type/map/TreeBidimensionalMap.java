...
import org.areasy.common.data.type.map.keyvalue.UnmodifiableMapEntry;
 ...
 * storage becomes significant. The {@link org.areasy.common.data.type.map.DualTreeBidimensionalMap} and
 * {@link org.areasy.common.data.type.map.DualHashBidimensionalMap} implementations use this approach.
 * <p/>
 ...
 *
 * @version $Id: TreeBidimensionalMap.java,v 1.2 2008/05/14 09:32:30 swd\stefan.damian Exp $
 */
public class TreeBidimensionalMap implements OrderedBidimensionalMap
{
	...
	private TreeBidimensionalMap.Inverse inverse = null;

	/**
	 * Constructs a new empty TreeBidiMap.
	 */
	public TreeBidimensionalMap()
	{
		super();
	}
	 ...
	 */
	public TreeBidimensionalMap(final Map map)
	{
		super();
		putAll(map);
	}
	...
	static class View extends AbstractSet
	{
		 ...
		 * The parent map.
		 */
		protected final TreeBidimensionalMap main;
		/**
		 ...
		 */
		View(final TreeBidimensionalMap main, final int orderType, final int dataType)
		{
			super();
			this.main = main;
	...
	static class ViewIterator implements OrderedIterator
	{
		 ...
		 * @param dataType  the KEY, VALUE, MAPENTRY or INVERSEMAPENTRY int
		 */
		ViewIterator(final TreeBidimensionalMap main, final int orderType, final int dataType)
		{
			super();
			this.main = main;
			this.orderType = orderType;
	...
	static class ViewMapIterator extends ViewIterator implements OrderedMapIterator
	{
		 ...
		 * @param orderType the KEY or VALUE int for the order
		 */
		ViewMapIterator(final TreeBidimensionalMap main, final int orderType)
		{
	...
	static class EntryView extends View
	{
		 ...
		 */
		EntryView(final TreeBidimensionalMap main, final int orderType, final int dataType)
		{
	 ...
	 * A node used to store the data.
	 */
	static class Inverse implements OrderedBidimensionalMap
	{

		/**
		 * The parent map.
		 */
		private final TreeBidimensionalMap main;
		/**
		 ...
		 * @param main the main map
		 */
		Inverse(final TreeBidimensionalMap main)
		{
			super();
			this.main = main;
		}
