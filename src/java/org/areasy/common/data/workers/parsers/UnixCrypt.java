...
public class UnixCrypt
{
	...
	public static String crypt(String key, String setting)
	{
		...
		/* invalid parameters! */
		if (key == null || setting == null) return "*"; // will NOT match under ANY circumstances!
	...
	/**
	 * Main class that will expose to the standard ouput crypt result.
	 *
	 * @param arg input arguments: key (the key to be encrypted) and salt
	 */
	public static void main(String[] arg)
	{
		...
		System.out.println("crypt > " + crypt(arg[0], arg[1]));
	}
}
