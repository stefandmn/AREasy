...
// <!-- rsaquo is proposed but not yet ISO standardized -->
	 ...
	 */
	public static final XHTMLEntities XML;

	/**
	 * <p>The set of entities supported by HTML 3.2.</p>
	 */
	public static final XHTMLEntities HTML32;

	/**
	 * <p>The set of entities supported by HTML 4.0.</p>
	 */
	public static final XHTMLEntities HTML40;

	static
	{
		XML = new XHTMLEntities();
	...
	static
	{
		HTML40 = new XHTMLEntities();
		fillWithHtml40Entities(HTML40);
	}

	static void fillWithHtml40Entities(XHTMLEntities entities)
	{
	...
	static abstract class MapIntMap implements XHTMLEntities.EntityMap
	{
	...
	// package scoped for testing
	EntityMap map = new XHTMLEntities.LookupEntityMap();
			...
			if (ch == '&')
			{
				...
				else if (entityName.charAt(0) == '#')
				{
					...
					else
					{
						...
						try
						{
							if (charAt1 == 'x' || charAt1 == 'X') entityValue = Integer.valueOf(entityName.substring(2), 16).intValue();
								else entityValue = Integer.parseInt(entityName.substring(1));
						}
				...
				else entityValue = this.entityValue(entityName);
				...
				else buf.append((char) (entityValue));
