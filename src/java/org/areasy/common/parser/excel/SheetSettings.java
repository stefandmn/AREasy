...
public final class SheetSettings
{
	...
	public SheetSettings(SheetSettings copy, Sheet s)
	{
		...
		{
			printArea = new DefaultSheetRange
					(sheet,
		...
		{
			printTitlesRow = new DefaultSheetRange
					(sheet,
		...
		{
			printTitlesCol = new DefaultSheetRange
					(sheet,
	...
	public void setPrintArea(int firstCol,
							 ...
							 int lastRow)
	{
		printArea = new DefaultSheetRange(sheet, firstCol, firstRow,
				lastCol, lastRow);
	}
	...
	public void setPrintTitlesRow(int firstRow,
								  int lastRow)
	{
		printTitlesRow = new DefaultSheetRange(sheet, 0, firstRow,
				255, lastRow);
	}
	 ...
	 *
	 * @param firstCol the first col of the print titles
	 * @param lastCol  the last col of the print titles
	 */
	public void setPrintTitlesCol(int firstCol, int lastCol)
	{
		printTitlesCol = new DefaultSheetRange(sheet, firstCol, 0,
				lastCol, 65535);
	}
