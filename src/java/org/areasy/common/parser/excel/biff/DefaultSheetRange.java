 ...
 */
public class DefaultSheetRange implements Range
{
	/**
	 ...
	 */
	public DefaultSheetRange(Sheet s, int c1, int r1,
						  int c2, int r2)
	{
		sheet = s;
		row1 = r1;
	 ...
	 */
	public DefaultSheetRange(DefaultSheetRange c, Sheet s)
	{
		sheet = s;
		row1 = c.row1;
		row2 = c.row2;
	 ...
	 */
	public boolean intersects(DefaultSheetRange range)
	{
		if (range == this)
		{
			return true;
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof DefaultSheetRange))
		{
			return false;
		}

		DefaultSheetRange compare = (DefaultSheetRange) o;
