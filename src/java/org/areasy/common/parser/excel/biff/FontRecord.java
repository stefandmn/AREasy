...
import org.areasy.common.parser.excel.format.ScriptStyle;
...
public class FontRecord extends WritableRecordData implements Font
{
	 ...
	 * The logger
	 */
	private static Logger logger = LoggerFactory.getLog(FontRecord.class);
	 ...
	 * DefaultWritableWorkbook to reset the statically declared fonts
	 */
