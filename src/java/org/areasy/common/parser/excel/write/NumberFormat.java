...
import org.areasy.common.parser.excel.write.biff.NumberFormatRecord;
...
public class NumberFormat extends NumberFormatRecord implements DisplayFormat
{
	 ...
	 */
	public static final NonValidatingFormat COMPLEX_FORMAT = new NumberFormatRecord.NonValidatingFormat();
