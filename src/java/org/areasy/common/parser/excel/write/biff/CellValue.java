		...
		implements WritableCell
{
	 ...
	 */
	public DefaultWritableSheet getSheet()
	{
		return sheet;
	}
	...
	public final void addCellFeatures()
	{
		...
		if (features.hasDataValidation())
		{
			...
			catch (org.areasy.common.parser.excel.biff.formula.FormulaException e)
			{
				Assert.verify(false);
			}
	...
	/**
	 * Internal function invoked by DefaultWritableSheet called when shared data
