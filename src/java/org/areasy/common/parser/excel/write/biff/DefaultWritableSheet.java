 ...
 */
class DefaultWritableSheet implements WritableSheet
{
	/**
	 * The logger
	 */
	private static Logger logger = LoggerFactory.getLog(DefaultWritableSheet.class);
	 ...
	 * The workbook
	 */
	private DefaultWritableWorkbook workbook;
	 ...
	 */
	public DefaultWritableSheet(String n,
							 File of,
							 FormattingRecords fr,
							 SharedStrings ss,
							 WorkbookSettings ws,
							 DefaultWritableWorkbook ww)
	{
		name = validateName(n);
		outputFile = of;
	 ...
	 * @throws org.areasy.common.parser.excel.write.biff.RowsExceededException
	 *
	 * @deprecated use the override which takes a CellView object
	 */
	...
	{
		settings = new SheetSettings(s.getSettings(), this);
		DefaultWritableSheet si = (DefaultWritableSheet) s;
			...
			throws WriteException, RowsExceededException
	{
		...
		DefaultSheetRange range = new DefaultSheetRange(this, col1, row1, col2, row2);
	 ...
	 * @return the workbook
	 */
	DefaultWritableWorkbook getWorkbook()
	{
		return workbook;
	}
