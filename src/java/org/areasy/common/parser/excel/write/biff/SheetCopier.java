...
import org.areasy.common.parser.excel.read.biff.DefaultSheet;
import org.areasy.common.parser.excel.read.biff.NameRecord;
import org.areasy.common.parser.excel.read.biff.WorkbookParser;
import org.areasy.common.parser.excel.write.*;
import org.areasy.common.parser.excel.write.Boolean;
 ...
 * in order to reduce the bloat of the DefaultWritableSheet
 */
class SheetCopier
{
	private static Logger logger = LoggerFactory.getLog(SheetCopier.class);

	private DefaultSheet fromSheet;
	private DefaultWritableSheet toSheet;
	...
	{
		fromSheet = (DefaultSheet) f;
		toSheet = (DefaultWritableSheet) t;
	...
	public void copySheet()
	{
		...
		org.areasy.common.parser.excel.read.biff.ColumnInfoRecord[] readCirs = fromSheet.getColumnInfos();

		for (int i = 0; i < readCirs.length; i++)
		{
			org.areasy.common.parser.excel.read.biff.ColumnInfoRecord rcir = readCirs[i];
		...
		{
			mergedCells.add(new DefaultSheetRange((DefaultSheetRange) merged[i], toSheet));
		}

		// Copy the row properties
		try
		{
			org.areasy.common.parser.excel.read.biff.RowRecord[] rowprops = fromSheet.getRowProperties();
		...
		{
			if (dr[i] instanceof org.areasy.common.parser.excel.biff.drawing.Drawing)
			{
			...
			else if (dr[i] instanceof org.areasy.common.parser.excel.biff.drawing.Comment)
			{
				org.areasy.common.parser.excel.biff.drawing.Comment c =
						new org.areasy.common.parser.excel.biff.drawing.Comment(dr[i],
			...
			else if (dr[i] instanceof org.areasy.common.parser.excel.biff.drawing.Button)
			{
				org.areasy.common.parser.excel.biff.drawing.Button b =
						new org.areasy.common.parser.excel.biff.drawing.Button
								(dr[i],
										toSheet.getWorkbook().getDrawingGroup(),
										workbookSettings);
				drawings.add(b);
			}
			else if (dr[i] instanceof org.areasy.common.parser.excel.biff.drawing.ComboBox)
			{
				org.areasy.common.parser.excel.biff.drawing.ComboBox cb =
						new org.areasy.common.parser.excel.biff.drawing.ComboBox
								(dr[i],
										toSheet.getWorkbook().getDrawingGroup(),
										workbookSettings);
				drawings.add(cb);
			}
			else if (dr[i] instanceof org.areasy.common.parser.excel.biff.drawing.CheckBox)
			{
				org.areasy.common.parser.excel.biff.drawing.CheckBox cb =
						new org.areasy.common.parser.excel.biff.drawing.CheckBox
								(dr[i],
										toSheet.getWorkbook().getDrawingGroup(),
										workbookSettings);
				drawings.add(cb);
	...
	public void copyWritableSheet()
	{
		...
		/*
			...
			for (int i = 0; i < merged.length; i++)
			{
			  mergedCells.add(new DefaultSheetRange((DefaultSheetRange)merged[i], this));
			}
	...
	public void importSheet()
	{
		...
		try
		{
			...
			for (int i = 0; i < rowprops.length; i++)
			{
				...
				org.areasy.common.parser.excel.read.biff.RowRecord rowrec = rowprops[i];
