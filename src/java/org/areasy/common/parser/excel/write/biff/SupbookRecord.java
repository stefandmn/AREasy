...
class SupbookRecord extends WritableRecordData
{
	 ...
	 */
	public SupbookRecord(org.areasy.common.parser.excel.read.biff.SupbookRecord sr, WorkbookSettings ws)
	{
		super(Type.SUPBOOK);
	 ...
	 */
	private void initInternal(org.areasy.common.parser.excel.read.biff.SupbookRecord sr)
	{
		numSheets = sr.getNumberOfSheets();
		initInternal();
	}
