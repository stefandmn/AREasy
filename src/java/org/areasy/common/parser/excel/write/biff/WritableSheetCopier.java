...
class WritableSheetCopier
{
	...
	private DefaultWritableSheet fromSheet;
	...
	{
		fromSheet = (DefaultWritableSheet) f;
	...
	public void copySheet()
	{
		...
		{
			toMergedCells.add(new DefaultSheetRange((DefaultSheetRange) merged[i],
					toSheet));
		}
		...
		{
			Object o = i.next();
			if (o instanceof org.areasy.common.parser.excel.biff.drawing.Drawing)
			{
				WritableImage wi = new WritableImage
						((org.areasy.common.parser.excel.biff.drawing.Drawing) o,
