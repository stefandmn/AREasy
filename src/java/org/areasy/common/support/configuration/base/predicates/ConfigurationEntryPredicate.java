 ...
 * The validation consists in checking only for instance type.
 *
 * @version $Id: ConfigurationEntryPredicate.java,v 1.2 2008/05/14 09:32:41 swd\stefan.damian Exp $
 */
public class ConfigurationEntryPredicate implements Predicate
{
	 ...
	 */
	public ConfigurationEntryPredicate(ConfigurationLocator locator)
	{
	...
	public boolean evaluate(Object object)
	{
		...
		return (entry.getLocator().equals(locator));
	}
}
