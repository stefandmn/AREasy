...
import org.areasy.runtime.actions.arserver.data.flow.events.AbstractEvent;
...
public class DataProcessAction extends PatternAction
{
	...
	static
	{
		events.put("readheaders", "org.areasy.runtime.actions.arserver.data.flow.events.ReadHeadersEvent");
		events.put("actionlist", "org.areasy.runtime.actions.arserver.data.flow.events.ReadActionlistEvent");
		events.put("runworkflow", "org.areasy.runtime.actions.arserver.data.flow.events.RunDataWorkflowEvent");
		events.put("loadmetadata", "org.areasy.runtime.actions.arserver.data.flow.events.LoadMetadataEvent");
		events.put("runscheduler", "org.areasy.runtime.actions.arserver.data.flow.events.RunSchedulerEvent");
		events.put("runautomap", "org.areasy.runtime.actions.arserver.data.flow.events.RunAutomapEvent");
		events.put("runjobexport", "org.areasy.runtime.actions.arserver.data.flow.events.RunJobExportEvent");
		events.put("runjobimport", "org.areasy.runtime.actions.arserver.data.flow.events.RunJobImportEvent");
	}
