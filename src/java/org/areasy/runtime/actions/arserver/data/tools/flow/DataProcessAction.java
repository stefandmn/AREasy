...
public class DataProcessAction extends FlowPatternAction
{
	...
	static
	{
		...
		events.put("runjobexport", "org.areasy.runtime.actions.arserver.data.tools.flow.events.RunJobExportEvent");
		events.put("runjobimport", "org.areasy.runtime.actions.arserver.data.tools.flow.events.RunJobImportEvent");
	}
