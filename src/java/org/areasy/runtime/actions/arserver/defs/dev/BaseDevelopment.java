...
public abstract class BaseDevelopment
{
	/** Library logger */
	protected static Logger logger = LoggerFactory.getLog(BaseDevelopment.class);
	...
	public BaseDevelopment(Configuration config, List objmap)
	{
		this.config = config;
		this.objmap = objmap;
	}
	 ...
	 */
	public abstract void perform(DevelopmentPackageAction develop);
	...
	/**
	 * Convert and normalize development records (<code>DevelopmentPackageObject</code> instances) into workflow object references
