...
import org.areasy.runtime.actions.arserver.defs.RemoveAction;
 ...
 */
public class DevelopmentRemove extends BaseDevelopment
{
	public DevelopmentRemove(Configuration config, List objmap)
	{
		super(config, objmap);
	}
	...
	public void perform(DevelopmentPackageAction develop)
	{
		...
		if(getObjectsList() != null && !getObjectsList().isEmpty())
		{
			...
			List<DevelopmentPackageObject> objects = getObjectsList();
			...
			for(int i = 0; objects != null && i < objects.size(); i++)
			{
				...
				try
				{
					...
					DevelopmentPackageObject devobj = objects.get(i);
	...
	public class DevelopmentPackageObjectComparator implements Comparator<DevelopmentPackageObject>
	{
		public int compare(DevelopmentPackageObject o1, DevelopmentPackageObject o2)
		{
			if(!StringUtility.equalsIgnoreCase(o1.getSignature(), BaseDevelopment.OBJ_FORM) && StringUtility.equalsIgnoreCase(o2.getSignature(), BaseDevelopment.OBJ_FORM)) return -1;
			else if(StringUtility.equalsIgnoreCase(o1.getSignature(), BaseDevelopment.OBJ_FORM) && !StringUtility.equalsIgnoreCase(o2.getSignature(), BaseDevelopment.OBJ_FORM)) return 1;
			else if(!StringUtility.equalsIgnoreCase(o1.getSignature(), BaseDevelopment.OBJ_FORM) && !StringUtility.equalsIgnoreCase(o2.getSignature(), BaseDevelopment.OBJ_FORM)) return 0;
			else if(StringUtility.equalsIgnoreCase(o1.getSignature(), BaseDevelopment.OBJ_FORM) && StringUtility.equalsIgnoreCase(o2.getSignature(), BaseDevelopment.OBJ_FORM)) return 0;
			else return 0;
		}
	}
