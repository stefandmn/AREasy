...
import org.areasy.runtime.actions.arserver.defs.RenameAction;
 ...
 * or repository.
 */
public class DevelopmentRename extends BaseDevelopment
{
	public DevelopmentRename(Configuration config, List objmap)
	{
		super(config, objmap);
	}
