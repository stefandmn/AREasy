...
import org.areasy.runtime.actions.arserver.defs.StatusAction;
 ...
 * or repository.
 */
public class DevelopmentStatus extends BaseDevelopment
{
	private boolean enable = false;
	
	public DevelopmentStatus(Configuration config, List objmap)
	{
		super(config, objmap);
	}
