...
public class RemoveHierarchicPermissionGroup extends SetHierarchicPermissionGroup implements RuntimeAction
{
	private static Logger logger = LoggerFactory.getLog(RemoveHierarchicPermissionGroup.class);
