...
public class ProcessInfo
{
	...
	{
		return " PID   NAME       PPID  OWNER      M TOTAL    M RES      TIME     COMMAND               \n" +
				"==========================================================================================";
	}
	...
	public String toString()
	{
		...
		return " " + stringFormat(pid, 5) + " " +
				...
				stringFormat(ParserUtility.diskSizeFormat(totalBytes), 10) + " " +
				stringFormat(ParserUtility.diskSizeFormat(residentBytes), 10) + " " +
				formatMillisecs(userMillis + systemMillis) + " " +
				stringFormat(command, 24);
	}
